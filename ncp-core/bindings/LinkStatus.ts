 ...
 */
export type LinkStatus = { ncp_version: string, kind: string, session_id: string, t: number, last_seq: bigint, received: bigint, lost: bigint, loss_rate: number, burst: boolean, };
