...
A reference Rust NCP edge for a NEST-based commander (e.g. Engram): a **binary** that runs
the Zenoh bus (queryable RPC + observation pub/sub) and bridges control-plane RPC to an
in-process Python `SessionService`.
